...
wget -O lcp.sh https://raw.githubusercontent.com/flclash-us/vps-guide-zb4542/main/lcp.sh
chmod +x lcp.sh
bash lcp.sh install
lcp start
...
wget -O tcp_optimize.sh https://raw.githubusercontent.com/flclash-us/vps-guide-zb4542/main/tcp_optimize.sh
